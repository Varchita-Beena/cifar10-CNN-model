...
The ones having batch normalization are added after activation function. In last three rows in table one more Conv2D-192, maxpool of kernel 2 and dropout of 0.5 is used.<br>
